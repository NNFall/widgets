...
После двух серий визуальных референсов уточнён баланс между простотой и
насыщенностью:
...
- рядом или ниже — реальный сайт и AI-виджет как визуальное доказательство;
- допускаются несколько преимуществ, role chips или шагов;
- плотность не должна превращать hero в административный dashboard.
...
`docs/research/assets/2026-07-26-kaigo-landing-references/`. Вторая серия из
десяти насыщенных вариантов сохранена в
`docs/research/assets/2026-07-26-kaigo-landing-references-rich/` и считается
актуальной.
