...
**Architecture:** Публичные платные планы остаются в серверном каталоге; вводный план содержит ссылку на скрытый баланс первого месяца 1 500 ₽/15 дней, а тот — на обычный месячный план 2 000 ₽/30 дней. Renewal worker проходит эту прозрачную цепочку. Бесплатный доступ хранится отдельным грантом и активной неавтопродлеваемой подпиской, а UI получает единый offer snapshot и не вычисляет коммерческие условия самостоятельно.
